...
const double fx = 482.2f;   // camera intrinsics
const double fy = -480.0f;
const double cx = 319.5f;
const double cy = 239.5f;
const int ncc_window_size = 2; // NCC window half size
const int ncc_area = (2*ncc_window_size+1)*(2*ncc_window_size+1); // NCC window area
const double min_cov = 0.1; // minimal threshold for similarity
const double max_cov = 10;  // maximal threshold for similarity


// read data from REMODE datasets
...
// check if the pix is in the image
