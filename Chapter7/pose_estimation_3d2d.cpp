...
int main(int argc, char** argv){
    ...
    cout << "All found " << matches.size() << " pairs " << endl;
...
/*在前端,我们通常考虑局部相机位姿和特征点的小型 Bundle Adjustment 问题,
 * 希望实时对它进行求解和优化。
 */
void bundleAdjustment (
        const vector< Point3f > points_3d,
        ...
        Mat& R, Mat& t ){
    // g2o initialization
    typedef g2o::BlockSolver < g2o::BlockSolverTraits<6,3> > Block; // pose dim: 6, landmark dim: 3
